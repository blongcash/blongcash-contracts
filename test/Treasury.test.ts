...
const INITIAL_CASH_AMOUNT = utils.parseEther('50000');
const INITIAL_SHARE_AMOUNT = utils.parseEther('10000');
  ...
  describe('seigniorage', () => {
    describe('#allocateSeigniorage', () => {
      beforeEach('transfer permissions', async () => {
        ...
        await cash.mint(operator.address, INITIAL_CASH_AMOUNT);
        await cash.mint(treasury.address, INITIAL_CASH_AMOUNT);
        await share.mint(operator.address, INITIAL_SHARE_AMOUNT);
